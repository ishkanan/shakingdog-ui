...
import { dismissFetchNotification } from "../actions/ui"
...
const FetchNotification = ({notification, onDismiss}) => {
...
const mapStateToProps = (state) => ({
  notification: state.getIn(["ui", "notification", "fetch"])
})

const mapDispatchToProps = ({
  onDismiss: dismissFetchNotification
})

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(toJS(FetchNotification))
